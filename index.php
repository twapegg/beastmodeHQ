    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-primary bg-opacity-25 px-4 py-3" data-bs-theme="dark">
        <div class="container-fluid">
            ...
            <a class="navbar-brand d-flex align-items-center w-25" href="#">
                <img src="./public/blackwhite.svg" alt="Logo" width="50" height="50" class="me-3  rounded-circle"> <!-- Replace with your logo path -->
                BeastModeHQ
            </a>
            <!-- Navbar Toggler -->
            ...
            <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                ...
                <div class="row w-100 d-flex justify-content-center justify-content-lg-end align-items-center gap-3 gap-lg-0">
                    <div class="col-12 col-lg-auto">
                        <a class="btn btn-tertiary text-light px-3 w-100" href="auth/login.php" role="button">Login</a>
                    </div>
                    <div class="col-12 col-lg-auto">
                        <a class="btn btn-brand text-light px-3 w-100" href="auth/signup.php" type="button">Get Started</a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="mt-15 col-md-8 offset-md-2 text-center">
                        ...
                        <div class="mt-5 d-flex justify-content-center gap-4">
                            <a href="./auth/signup.php" class="btn btn-light text-primary btn-lg"><strong>Join the Pack</strong></a>
            ...
            <div id="carouselExample" class="carousel slide custom-carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="https://southsidegym.ie/wp-content/uploads/2023/04/P1255237-900x1200.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="https://southsidegym.ie/wp-content/uploads/2023/04/P1255289-900x1200.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="https://southsidegym.ie/wp-content/uploads/2023/04/P1255246-900x1200.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="https://southsidegym.ie/wp-content/uploads/2023/04/P1255243-900x1200.jpg" class="d-block w-100" alt="...">
                    </div>
                    <div class="carousel-item">
                        <img src="https://southsidegym.ie/wp-content/uploads/2023/04/P1255297-900x1200.jpg" class="d-block w-100" alt="...">
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm bg-dark text-light">
                        <div class="card-body d-flex flex-column p-4">
                            ...
                            <p class="card-text text-secondary">Experience the latest in fitness technology to maximize your workouts.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm bg-dark text-light">
                        <div class="card-body d-flex flex-column p-4">
                            ...
                            <p class="card-text text-secondary">Join a variety of classes led by expert instructors to suit all fitness levels.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm bg-dark text-light">
                        <div class="card-body d-flex flex-column p-4">
                            ...
                            <p class="card-text text-secondary">Relax and rejuvenate with our luxurious spa services after your workout.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm bg-dark text-light">
                        <div class="card-body d-flex flex-column p-4">
                            ...
                            <p class="card-text text-secondary">Get personalized advice and plans from our certified fitness counselors.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm bg-dark text-light">
                        <div class="card-body d-flex flex-column p-4">
                            ...
                            <p class="card-text text-secondary">Join a community of like-minded individuals who motivate and inspire.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
                    <div class="card h-100 shadow-sm bg-dark text-light">
                        <div class="card-body d-flex flex-column p-4">
                            ...
                            <p class="card-text text-secondary">Train with the best in the industry to achieve your fitness goals.</p>
                        </div>
                    </div>
                </div>
            </div>
